      ...
      <div className={styles.content}>
        ...
        <ul>
          <li>
            ...
            />
            <h3>Captain Sarah Vega: </h3> <br />A former NASA astronaut with
          ...
          <li>
            ...
            <br /> With his extensive background in aerospace engineering, Mark
            Shuttleworth is responsible for the state-of-the-art technology that
            powers our spacecraft. His innovation ensures that our travelers are
          ...
          <li>
            ...
            <h3>Crew Member Maya Patel:</h3> <br />
